  ...
  tab_file_h.each do |line|
    ...
    novel_genes.each do |gene_key|
      ...
      if strand == "+"
        ...
        puts sequence_novel = Bio::Sequence::NA.new(sequence_novel).reverse_complement.split("ATG")[1..-1].join("").translate
        puts sequence_original = Bio::Sequence::NA.new(sequence_original).reverse_complement.split("ATG")[1..-1].join("").translate
      end
      STDIN.gets
